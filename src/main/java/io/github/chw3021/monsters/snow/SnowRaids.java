...
public class SnowRaids extends Summoned {
	...
	final private void Mob4(Location spl, String rn) {
		...
		head.addUnsafeEnchantment(Enchantment.FIRE_PROTECTION, 5);
		head.addUnsafeEnchantment(Enchantment.PROTECTION, 1);
		head.addUnsafeEnchantment(Enchantment.PROJECTILE_PROTECTION, 1);
	...
	final private void Mob6(Location spl, String rn) {
		...
		Snowman newmob = (Snowman) Summon(esl, ChatColor.AQUA+reg + "<"+rn+">", 550.0, head, null, null, null, null, null, EntityType.SNOW_GOLEM);

	...
	public void TaoSkillsinv(Player p)
	{
		...
		if(p.getLocale().equalsIgnoreCase("ko_kr")) {
			...
			if(Proficiency.getpro(p)<1) {
				...
				itemset("속박진(잠김)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("요구 숙련도: "+ Proficiency.getproexp(p) + "/29315"), 13, Taoskillsinv);
				...
				itemset("기공참", Material.DIAMOND_SWORD, 0, 1, Arrays.asList("재입력시 기공참을 사용합니다","",ChatColor.BOLD+"2 X (0.68D + "+BigDecimal.valueOf(tsd.Wave.getOrDefault(p.getUniqueId(), 0)*0.76).setScale(2, RoundingMode.HALF_EVEN)+")","(피해량은 기공권 레벨에 비례합니다)"), 11, Taoskillsinv);
				...
				itemset("속박진", Material.COARSE_DIRT, 0, 1, Arrays.asList("재입력시 속박진을 사용합니다","",ChatColor.BOLD+"10 X (0.115D + "+BigDecimal.valueOf(tsd.Charm.getOrDefault(p.getUniqueId(), 0)*0.2455).setScale(2, RoundingMode.HALF_EVEN)+")","(피해량은 부적 레벨에 비례합니다)"), 13, Taoskillsinv);
				itemset("순보", Material.NETHERITE_BOOTS, 0, 1, Arrays.asList("재입력시 순보를 사용합니다","",ChatColor.BOLD+" X (0.9D + "+BigDecimal.valueOf(tsd.Flip.getOrDefault(p.getUniqueId(), 0)*0.9).setScale(2, RoundingMode.HALF_EVEN)+")","(피해량은 공중제비 레벨에 비례합니다)"), 14, Taoskillsinv);
				...
				itemset("명상", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("웅크리기 + num4","주변 파티원들을 치료합니다","",ChatColor.BOLD+"60 X 0.3D"), 17, Taoskillsinv);
				...
				itemset("음양팔괘진", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("웅크리기 + num5","",ChatColor.BOLD+"8 X 1.5D, 3.5D, 12.5D"), 26, Taoskillsinv);
			}
			...
			if(Proficiency.getpro(p)<1) {
				...
				itemset("BindingFormation(Locked)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("Required Proficiency: "+ Proficiency.getproexp(p) + "/29315"), 13, Taoskillsinv);
				...
				itemset("BindingFormation", Material.COARSE_DIRT, 0, 1, Arrays.asList("Use BindingFormation When Use Once More","",ChatColor.BOLD+"10 X (0.115D + "+BigDecimal.valueOf(tsd.Charm.getOrDefault(p.getUniqueId(), 0)*0.2455).setScale(2, RoundingMode.HALF_EVEN)+")","(Damage Affected By Charm)"), 13, Taoskillsinv);
				...
				itemset("Meditation", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("Sneaking + num4","Heal Near Party","",ChatColor.BOLD+"60 X 0.3D"), 17, Taoskillsinv);
				...
				itemset("EnergyBlast(Locked)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("Required Proficiency: "+ Proficiency.getproexp(p) + "/155015"), 22, Taoskillsinv);
				...
				itemset("Eight Trigrams Formation(Locked)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("Required Proficiency: "+ Proficiency.getproexp(p) + "/155015"), 26, Taoskillsinv);
			}
			else {
				itemset("MentalTraining", Material.SOUL_CAMPFIRE, 0, 1, Arrays.asList("Doubles Aura Buff Effect"), 9, Taoskillsinv);
				itemset("Blast", Material.FIREWORK_STAR, 0, 1, Arrays.asList("Use Blast When Use Once More","",ChatColor.BOLD+" X (1.4D + "+BigDecimal.valueOf(tsd.Imagery.getOrDefault(p.getUniqueId(), 0)*1.5).setScale(2, RoundingMode.HALF_EVEN)+")","(Damage Affected By Imagery)"), 10, Taoskillsinv);
				...
				itemset("EnergyBlast", Material.SOUL_CAMPFIRE, 0, 1, Arrays.asList("Use EnergyBlast When Use Once More","",ChatColor.BOLD+"12 X (0.1D + "+BigDecimal.valueOf(tsd.Charm.getOrDefault(p.getUniqueId(), 0)*0.12).setScale(2, RoundingMode.HALF_EVEN)+")","(Damage Affected By Charm)"), 22, Taoskillsinv);
				...
				itemset("Eight Trigrams Formation", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("Sneaking + num5","",ChatColor.BOLD+"8 X 1.5D, 3.5D, 12.5D"), 26, Taoskillsinv);
			}

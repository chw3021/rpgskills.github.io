...
public class OceSkillsGui{
	...
	public void OceSkillsinv(Player p)
	{
		...
		if(p.getLocale().equalsIgnoreCase("ko_kr")) {
			...
			itemset("삼연격", Material.TRIDENT, 0, 1, Arrays.asList(ChatColor.AQUA+"LV."+fsd.TripleHit.getOrDefault(p.getUniqueId(),0),"",ChatColor.UNDERLINE+"[물 계열]","웅크리기 + 근접공격","",ChatColor.BOLD+"3 X "+BigDecimal.valueOf(0.7*(1+fsd.TripleHit.getOrDefault(p.getUniqueId(),0)*0.0453)).setScale(2, RoundingMode.HALF_EVEN)+"D", "Master Lv.50"), 4, Oceskillsinv);
			...
			if(Proficiency.getpro(p)<1) {
				...
				itemset("삼지창찍기(잠김)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("요구 숙련도: "+ Proficiency.getproexp(p) + "/29315"), 10, Oceskillsinv);
				...
				itemset("방패강타(잠김)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("요구 숙련도: "+ Proficiency.getproexp(p) + "/29315"), 13, Oceskillsinv);
				...
				itemset("거대한 파도(잠김)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("요구 숙련도: "+ Proficiency.getproexp(p) + "/29315"), 17, Oceskillsinv);
			}
				...
				itemset("삼지창찍기", Material.DARK_PRISMARINE_SLAB, 0, 1, Arrays.asList(ChatColor.UNDERLINE+"[물 계열]","재입력시 삼지창찍기을 사용합니다","(피해량은 물의방벽 레벨에 비례합니다)","",ChatColor.BOLD+" X "+BigDecimal.valueOf(0.65*(1+fsd.WaterBarrier.getOrDefault(p.getUniqueId(),0)*0.045)).setScale(2, RoundingMode.HALF_EVEN)+"D"), 10, Oceskillsinv);
				...
				itemset("방패강타", Material.DARK_PRISMARINE, 0, 1, Arrays.asList(ChatColor.UNDERLINE+"[물 계열]","삼연격이후 재공격시 방패강타를 사용합니다","(피해량은 삼연격 레벨에 비례합니다)","",ChatColor.BOLD+" X "+BigDecimal.valueOf(0.7*(1+fsd.TripleHit.getOrDefault(p.getUniqueId(),0)*0.07)).setScale(2, RoundingMode.HALF_EVEN)+"D"), 13, Oceskillsinv);
				...
				itemset("해일", Material.WRITTEN_BOOK, 0, 1, Arrays.asList(ChatColor.UNDERLINE+"[물 계열]","웅크리기 + 아이템던지기","",ChatColor.BOLD+"4 X 2.5D, 9.8D"), 17, Oceskillsinv);
				...
				itemset("찌르기", Material.TRIDENT, 0, 1, Arrays.asList(ChatColor.UNDERLINE+"[물 계열]","방패강타후 재공격시 찌르기를 사용합니다","(피해량은 삼연격 레벨에 비례합니다)","",ChatColor.BOLD+" X "+BigDecimal.valueOf(1.1*(1+fsd.TripleHit.getOrDefault(p.getUniqueId(),0)*0.0834)).setScale(2, RoundingMode.HALF_EVEN)+"D"), 22, Oceskillsinv);
				...
				itemset("용맹", Material.ENCHANTED_BOOK, 0, 1, Arrays.asList("공격력과 방어력이 증가합니다","해일 대기시간이 감소합니다"), 25, Oceskillsinv);
			...
			itemset("TripleHit", Material.TRIDENT, 0, 1, Arrays.asList(ChatColor.AQUA+"LV."+fsd.TripleHit.getOrDefault(p.getUniqueId(),0),"",ChatColor.UNDERLINE+"[Water]","Sneaking + Hit","",ChatColor.BOLD+"3 X "+BigDecimal.valueOf(0.7*(1+fsd.TripleHit.getOrDefault(p.getUniqueId(),0)*0.0453)).setScale(2, RoundingMode.HALF_EVEN)+"D", "Master Lv.50"), 4, Oceskillsinv);
			...
			if(Proficiency.getpro(p)<1) {
				...
				itemset("TridentDrive(Locked)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("Required Proficiency: "+ Proficiency.getproexp(p) + "/29315"), 10, Oceskillsinv);
				...
				itemset("ShieldSmite(Locked)", Material.STRUCTURE_VOID, 0, 1, Arrays.asList("Required Proficiency: "+ Proficiency.getproexp(p) + "/29315"), 13, Oceskillsinv);
				...
				itemset("TridentDrive", Material.DARK_PRISMARINE_SLAB, 0, 1, Arrays.asList(ChatColor.UNDERLINE+"[Water]","Use TridentDrive When Use Once More","(Damage Affected By WaterBarrier)","",ChatColor.BOLD+" X "+BigDecimal.valueOf(0.65*(1+fsd.WaterBarrier.getOrDefault(p.getUniqueId(),0)*0.045)).setScale(2, RoundingMode.HALF_EVEN)+"D"), 10, Oceskillsinv);
				...
				itemset("ShieldSmite", Material.DARK_PRISMARINE, 0, 1, Arrays.asList(ChatColor.UNDERLINE+"[Water]","Smite With Shield After TripleHit","(Damage Affected By TripleHit)","",ChatColor.BOLD+" X "+BigDecimal.valueOf(0.7*(1+fsd.TripleHit.getOrDefault(p.getUniqueId(),0)*0.07)).setScale(2, RoundingMode.HALF_EVEN)+"D"), 13, Oceskillsinv);
				...
				itemset("Impale", Material.TRIDENT, 0, 1, Arrays.asList(ChatColor.UNDERLINE+"[Water]","Impale After ShieldSmite","(Damage Affected By TripleHit)","",ChatColor.BOLD+" X "+BigDecimal.valueOf(1.1*(1+fsd.TripleHit.getOrDefault(p.getUniqueId(),0)*0.0834)).setScale(2, RoundingMode.HALF_EVEN)+"D"), 22, Oceskillsinv);

	...
	public void Hunskillsinv(Player p)
	{
		...
		if(p.getLocale().equalsIgnoreCase("ko_kr")) {
			...
			if(Proficiency.getpro(p)<1) {
				...
				itemset("갈망", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("웅크리기 + num4", "참격과 두개골분쇄의 대기시간이 초기화됩니다","",ChatColor.BOLD+"X 27.1D"), 17, Hunskillsinv);
				...
				itemset("집행", Material.WRITTEN_BOOK, 0, 1, Arrays.asList(ChatColor.UNDERLINE+"[바람 계열]","웅크리기 + num5", "참격과 두개골분쇄의 대기시간이 초기화됩니다","",ChatColor.BOLD+"X 33.2D"), 26, Hunskillsinv);
			}

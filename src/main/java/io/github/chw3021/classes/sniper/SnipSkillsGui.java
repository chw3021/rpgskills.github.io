	...
	public void Snipskillsinv(Player p)
	{
		...
		if(p.getLocale().equalsIgnoreCase("ko_kr")) {
			...
			if(Proficiency.getpro(p)<1) {
				...
				itemset("최후의 한발", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("웅크리기 + num4","",ChatColor.BOLD+"+ 10.0D"), 17, skillsInv);
				...
				itemset("독수리분대", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("웅크리기 + num5","",ChatColor.BOLD+"40 X 0.5D, 6.5D"), 26, skillsInv);
			}
			...
			if(Proficiency.getpro(p)<1) {
				...
				itemset("The Last One", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("Sneaking + num4","",ChatColor.BOLD+"+ 10.0D"), 17, skillsInv);
				...
				itemset("Team Eagle", Material.WRITTEN_BOOK, 0, 1, Arrays.asList("Sneaking + num5","",ChatColor.BOLD+"40 X 0.5D, 6.5D"), 26, skillsInv);
			}

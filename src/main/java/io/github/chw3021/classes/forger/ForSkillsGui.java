...
public class ForSkillsGui extends SkillsGui{
	...
	public void ForSkillsinv(Player p)
	{
		...
		if(p.getLocale().equalsIgnoreCase("ko_kr")) {
			...
			itemset("충격파", Material.STONE_PICKAXE, 0, 1, Arrays.asList(ChatColor.AQUA+"LV."+fsd.DoubleBarrel.getOrDefault(p.getUniqueId(),0),"",ChatColor.UNDERLINE+"[번개 계열]","좌클릭","",ChatColor.BOLD+"2 X 0.135D", "Master LV.1"), 2, Forskillsinv);
			...
			itemset("Shockwave", Material.STONE_PICKAXE, 0, 1, Arrays.asList(ChatColor.AQUA+"LV."+fsd.DoubleBarrel.getOrDefault(p.getUniqueId(),0),"",ChatColor.UNDERLINE+"[Lightning]","LeftClick","",ChatColor.BOLD+"2 X 0.135", "Master LV.1"), 2, Forskillsinv);

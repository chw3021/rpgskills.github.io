		...
		if (p.getLocale().equalsIgnoreCase("ko_kr")) {
			...
			itemset("얼음수정", Material.BLUE_ICE, 0, 1,
					Arrays.asList(ChatColor.AQUA + "LV." + bsd.FrozenCrystal.getOrDefault(p.getUniqueId(), 0), "",
							ChatColor.UNDERLINE + "[서리 계열]", "손바꾸기", "재사용시 일찍 깨뜨릴수 있습니다", "",
							ChatColor.BOLD + ""
			...
			itemset("우박", Material.PACKED_ICE, 0, 1,
					Arrays.asList(ChatColor.AQUA + "LV." + bsd.Hailstones.getOrDefault(p.getUniqueId(), 0), "",
							ChatColor.UNDERLINE + "[서리 계열]", "웅크리기 + 손바꾸기", "",
							ChatColor.BOLD + "20 X "
			...
			itemset("거대고드름", Material.PRISMARINE_SHARD, 0, 1,
					Arrays.asList(ChatColor.AQUA + "LV." + bsd.IceSpikes.getOrDefault(p.getUniqueId(), 0), "",
							ChatColor.UNDERLINE + "[서리 계열]", "웅크리기 + 우클릭", "",
							ChatColor.BOLD + "25 X "
			...
			itemset("눈바람", Material.SNOW_BLOCK, 0, 1,
					Arrays.asList(ChatColor.AQUA + "LV." + bsd.SnowBreeze.getOrDefault(p.getUniqueId(), 0), "",
							ChatColor.UNDERLINE + "[서리 계열]", "점프 + 좌클릭", "", ChatColor.BOLD + "0.25D",
							"Master LV.1"),
					5, Frostskillsinv);
			...
			if (Proficiency.getpro(p) < 1) {
				itemset("추위(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/29315"), 9, Frostskillsinv);
				itemset("눈사태(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/29315"), 10, Frostskillsinv);
				itemset("눈덩이(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/29315"), 11, Frostskillsinv);
				itemset("극소용돌이(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/29315"), 12, Frostskillsinv);
				itemset("크레바스(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/29315"), 13, Frostskillsinv);
				itemset("빙폭(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/29315"), 14, Frostskillsinv);
				itemset("냉혈(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/29315"), 16, Frostskillsinv);
				itemset("서리폭풍(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/29315"), 17, Frostskillsinv);
			} else if (Proficiency.getpro(p) < 2 && Proficiency.getpro(p) >= 1) {
				itemset("한기", Material.POWDER_SNOW_BUCKET, 0, 1,
						Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]", "수정이 깨진후 주변적에게 추가 피해를 줍니다", "기절시간이 증가합니다", "",
								ChatColor.BOLD + "4 X "
				...
				itemset("눈사태", Material.SNOW, 0, 1,
						Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]", "재입력시 눈사태를 사용합니다", "(피해량은 우박 레벨에 비례합니다)", "",
								ChatColor.BOLD + "1 X "
				...
				itemset("눈덩이", Material.SNOWBALL, 0, 1,
						Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]", "재입력시 눈덩이를 사용합니다", "(피해량은 고드름화살 레벨에 비례합니다)", "",
								ChatColor.BOLD + "4 X "
				...
				itemset("극소용돌이", Material.WHITE_TULIP, 0, 1,
						Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]", "재입력시 극소용돌이를 사용합니다", "(피해량은 거대고드름 레벨에 비례합니다)",
								"",
								ChatColor.BOLD + "5 X "
				...
				itemset("서리폭풍", Material.WRITTEN_BOOK, 0, 1, Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]",
						"웅크리기 + num4", "", ChatColor.BOLD + "60 X 0.32D"), 17, Frostskillsinv);
				...
				itemset("극한의추위(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/155015"), 19, Frostskillsinv);
				itemset("서리칼날(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/155015"), 20, Frostskillsinv);
				itemset("빙적(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/155015"), 21, Frostskillsinv);
				itemset("복빙(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/155015"), 22, Frostskillsinv);
				itemset("절대영도(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/155015"), 25, Frostskillsinv);
				itemset("빙하시대(잠김)", Material.STRUCTURE_VOID, 0, 1,
						Arrays.asList("요구 숙련도: " + Proficiency.getproexp(p) + "/155015"), 26, Frostskillsinv);
			} else {
				itemset("한기", Material.POWDER_SNOW_BUCKET, 0, 1,
						Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]", "수정이 깨진후 주변적에게 추가 피해를 줍니다", "기절시간이 증가합니다", "",
								ChatColor.BOLD + "4 X "
				...
				itemset("대균열", Material.ICE, 0, 1, Arrays.asList("범위가 증가합니다"), 18, Frostskillsinv);
				itemset("극한의추위", Material.WHITE_SHULKER_BOX, 0, 1,
						Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]", "재입력시 극한의추위를 사용합니다", "(피해량은 우박 레벨에 비례합니다)", "",
								ChatColor.BOLD + "6 X "
				...
				itemset("서리칼날", isw, 0, 1,
						Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]", "재입력시 서리칼날을 사용합니다", "(피해량은 고드름화살 레벨에 비례합니다)", "",
								ChatColor.BOLD + "5 X  "
				...
				itemset("빙적", Material.PRISMARINE_SHARD, 0, 1,
						Arrays.asList(ChatColor.UNDERLINE + "[서리 계열]", "재입력시 빙적을 사용합니다", "(피해량은 거대고드름 레벨에 비례합니다)", "",
								ChatColor.BOLD + "20 X "
